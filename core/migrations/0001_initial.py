# Generated by Django 2.2.14 on 2020-11-06 12:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('S', 'Shirt'), ('SW', 'Sport Wears'), ('OW', 'Outwear')], default='S', max_length=50)),
                ('label', models.CharField(choices=[('S', 'secondary'), ('D', 'danger'), ('P', 'primary')], default='P', max_length=50)),
